      ...
      <footer className="footer footer-center p-10 dark:bg-gradient-to-r dark:to-[#060606] dark:via-[#060606] dark:from-[#2B2C41] bg-slate-100 text-primary-content mt-5 rounded-t-lg">
        <aside>
          <div className="flex justify-center items-center p-10">
            ...
            <a className="font-semibold lg:text-5xl text-4xl dark:text-white text-black backdrop-filter p-1">
              Gari Dekhun
            </a>
          </div>
          <p className="font-bold dark:text-white text-black">
            Gari Dekhun Providing reliable Dealer since 2010
          </p>
        ...
        <nav>
          <div className="grid grid-flow-col gap-4 dark:text-white text-black">
            <a>
              <svg
